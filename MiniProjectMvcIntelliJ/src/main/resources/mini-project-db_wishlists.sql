...
CREATE TABLE `wishlists` (
  ...
  `wishlist_owner_email` varchar(100) NOT NULL
...
INSERT INTO `wishlists` VALUES ('qwqwqwq','vs@hotmail.com'),('Julegaver til mig','vs@hotmail.com');
...
-- Dump completed on 2021-11-09 13:37:55
